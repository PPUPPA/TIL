...
console.log("enqueue queue_1: " + benchmark(queue_1, 1) + "ms"); // enqueue queue_1: 6ms
console.log("enqueue queue_2: " + benchmark(queue_2, 1) + "ms"); // enqueue queue_2: 5ms
console.log("dequeue queue_1: " + benchmark(queue_1, 0) + "ms"); // dequeue queue_1: 5779ms
console.log("dequeue queue_2: " + benchmark(queue_2, 0) + "ms"); // dequeue queue_2: 9ms
